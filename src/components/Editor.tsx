  ...
  return (
    <div className="prose bg-white py-4">
      ...
      <p>
        ...
        definitely would love to, but I’d like to take a leave of absence when I
        was there. So they let me do that, and I ended up in Switzerland and
      ...
      <p>
        I’m stupefied to sort of summarize [my trip to India]. Anyone would have
        a hard time summarizing a meaningful experience of their life in a page.
        I mean, if I was William Faulkner, I might be able to do it for you, but
        I’m not.
      </p>
      <p>
        Coming back was more of a culture shock than going. All I really wanted
        to do [after returning to California] was to go find a grassy meadow and
        just sit. I didn’t want to drive a car. I didn’t want to go to San
        Francisco or do all these things. I didn’t want to do it. So I didn’t,
        for about three months. I just read and sat. When you are a stranger in
        a place, you notice things that you rapidly stop noticing when you
        become familiar.
      </p>
      <p>
        I was a stranger in America for the first time in my life, and so I saw
        things I’d never seen before. And I tried to pay attention to them for
        those three months because I knew that gradually, bit by bit, my
